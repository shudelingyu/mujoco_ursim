...
!!!***so3 ����3X3���Գƾ���ļ���***!!!
 ...
 [x]=[0 -x3 x2
	  ...
	  -x2 x1  0]
 RΪ������Թ̶�����ϵ����̬����
 ��������ϵ[wb]=R.inv*R.dot= ����ھ�����ϵ{b}�Ľ��ٶ�
 �̶�����ϵ[ws]=R.dot*R.inv
 D�����C����ת������wc=Rcd*wd

 ָ������ϵ��ʾ  w^*thetaΪ������ָ����ʾ   ����дw^��thetaΪ���   p47ҳ
 ��λת��w^���Ƹ����ߵ�ת��theta��ͨ�����˵õ���ά����
 **��ά����p�뵥λת��w^��theta   p50
 p.dot=w^ X p=[w^]p =>΢�ַ��� p(theta)=e^[w^]theta *p(0)
 �޵����˹����      p50ҳ
 ...
 �����˶�����(��������ϵ�ϵ��ٶ�) 
  T.inv * T.dot Ϊ������ϵ��Ե�ǰ����˲ʱ�غϵľ�����ϵ{b}�����ٶ�����ٶ� p59ҳ
 Vb=[wb
	 vb]
Ⱥse(3)  ������� ���Գ���
 ...
 �κθ����˶�������ͨ���ƿռ�ĳһ�̶���������S���˶���ʵ��
 ������S=(w,v)�Ľھ�Ϊ����ֵ��||w||=1,thetaΪ����������ת�ĽǶ�
 ������S=(w,v)�Ľھ�Ϊ����ֵ��w=0,||v||=1,thetaΪ���������ƶ��ľ���
 ���������ָ������
 ת����||w||=1
 ...
 ��������ľ������
 ��������ο�p65ҳ   ��֪��ת������������
 ��������ģ�R,p) & SE(3)�����ҵ���Ӧ��������S=��w,v)�ͱ���theta����
 e^([S]theta)=[R    p
			   0    1]
����[S]=[[w] v
	      0  0]
 ����ma=ra X fa
 �ռ�������:Fa=[ma  =[AdTba]^T*Fb      p67ҳ
			   fa]
...
ĩ��T= e^([Sn]thetan)M
Sn=��wn,vn)�ڻ�����ϵ�еĹؽ�N����������
���У�ת��  vn=-wn X qn ��qnΪ�ؽ�������һ��
	  �ƶ�  wn=0,vnΪ�ؽ�����λ������thetaΪ�ƶ�����

///*********΢���˶�ѧ  p108ҳ
������ĩ���ٶ� x.dot=J(theta) *theta.dot
�ſɱȣ�ĩ���ٶ����
�ؽ�������ؽ����ع�ϵ
tor=J.inv(theta)*f
f=J.-inv(theta)*tor
...
!!!!!!
����λ��theta����ά����J(theta),�����ſɱȾ���ĵ�i�У��ǵ�theta(i).dot=1,�����ؽ�����Ϊ0���˶�����V

�ռ��ſɱ� Vs=Js(theta) * theta().dot            p111ҳ      
      
Jsi��ÿһ�ж�Ӧ�ռ�̶�����ϵ{s}�и��ؽ����������������
Vs==[Vs]=T.dot*T.inv=Js1*theta(1).dot+Js2*theta(2).dot+....
ע�ⶨ��5.1     p111ҳ   ���J1  J2   J3.......

[vb]=[[ws] vs  =T.dot*T.inv
		 0   0]

